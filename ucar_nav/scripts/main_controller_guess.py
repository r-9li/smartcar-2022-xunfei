...
current_angle_q = 0  # 小车目前朝向(四元数形式)
angle_speed = 2.5  # 旋转速度
...
goal_pose_1 = [-4.52908039093
    , 2.72088432312, 0.866336267812, 0.499461180748]
goal_pose_2 = [-2.91499304771, 4.11055374146, 0.715946289373, 0.698155362891]
goal_pose_3 = [-1.796517372, 2.514158725, 0.7137065302, 0.7004448506]
goal_pose_4 = [-0.0281128, 0.8121339, -0.016900325, 0.999857179305]
goal_pose_5 = [0.094, 0.879, -0.016900325, 0.999857179305]  # 准但是慢
angle_list_1 = [0]
angle_list_2 = [0, 50,215]
angle_list_3 = [0]
